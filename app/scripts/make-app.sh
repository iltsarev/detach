...
BUILTIN_PET_SOURCE="$APP_ROOT/Resources/Pets/lumi"
...
install -d -m 0755 "$BUILTIN_PET"
install -m 0644 "$BUILTIN_PET_SOURCE/pet.json" "$BUILTIN_PET/pet.json"
install -m 0644 "$BUILTIN_PET_SOURCE/spritesheet.webp" \
  "$BUILTIN_PET/spritesheet.webp"
